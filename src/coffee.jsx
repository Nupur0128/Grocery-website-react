...
export default function Coffee() {
  ...
  const [counts, setCounts] = useState(Array(5).fill(1));
  const [selectedFilters, setSelectedFilters] = useState([]);

  const dealsImg = [
    { img: "/coffee1.jpg", name: "Instant Coffee, Rich Aroma", price: "$ 5.99", category: "Beverages" },
    { img: "/coffee2.jpg", name: "Decaffeinated Instant Coffee, Rich Aroma", price: "$ 4.49", category: "Beverages" },
    { img: "/coffee3.jpg", name: "Vietnam Blend Whole Bean Coffee", price: "$ 3.99", category: "Most Popular" },
    { img: "/coffee4.jpg", name: "Colombian, Ground Coffee", price: "$ 0.99", category: "Deals" },
    { img: "/coffee5.jpg", name: "Brazilian, Medium Roast", price: "$ 2.69", category: "Deals" },
  ];

  const filters = ["Beverages", "Deals", "Most Popular"];
  ...
  return (
    <div className="p-6 sm:p-16">
      <h1 className="font-semibold text-3xl sm:text-5xl text-center mb-8">
        Coffee
      </h1>
      ...
      <div className="flex">
        ...
        <main className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 flex-1">
          {filteredProducts.map((item, index) => (
            ...
            >
              <button className="px-4 py-1 text-xs font-medium bg-red-600 text-white rounded-full">
                {item.category}
              </button>
              <img
                src={item.img}
