...
export default function Wine() {
  ...
  const dealsImg = [
    { img: "/wine1.jpg", name: "Chinon Rose 750 ml.", price: "$ 5.99", category: "Deals" },
    { img: "/wine2.jpg", name: "Cabernet Sauvignon 750 ml.", price: "$ 4.49", category: "Deals" },
    { img: "/wine3.jpg", name: "Sauvignon Blanc 750 ml.", price: "$ 3.99", category: "Most Popular" },
    { img: "/wine4.jpg", name: "Chardonnay 750 ml.", price: "$ 0.99", category: "Most Popular" },
    { img: "/wine5.jpg", name: "Lux Rose 750 ml.", price: "$ 2.69", category: "Deals" },
  ];
