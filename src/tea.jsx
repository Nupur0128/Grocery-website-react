...
export default function Tea() {
  ...
  const dealsImg = [
    { img: "/tea1.jpg", name: "Chamomile Tea 16 ct.", price: "$ 5.99", category: "Deals" },
    { img: "/tea2.jpg", name: "Herbal Tea 16 ct.", price: "$ 4.49", category: "Deals" },
    { img: "/tea3.jpg", name: "Black Tea 16 ct.", price: "$ 3.99", category: "Most Popular" },
    { img: "/tea4.jpg", name: "White Tea 16 ct.", price: "$ 0.99", category: "Most Popular" },
    { img: "/tea5.jpg", name: "Green Tea 16 ct.", price: "$ 2.69", category: "Deals" },
  ];
