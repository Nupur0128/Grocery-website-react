...
export default function Meat() {
  ...
  const dealsImg = [
    { img: "/meat1.jpg", name: "Boneless Chicken Thighs - 1lb", price: "$ 4.04", category: "Deals" },
    { img: "/meat2.jpg", name: "Italian Chicken Sausage - 1lb", price: "$ 6.99", category: "Most Popular" },
    { img: "/meat3.jpg", name: "Beef Fillet - 1lb", price: "$ 9.99", category: "Deals" },
    { img: "/meat4.jpg", name: "Boneless Chicken Breasts - 1lb", price: "$ 8.49", category: "Most Popular" },
    { img: "/meat5.jpg", name: "Steak A-La-Minute - 1lb", price: "$ 9.99", category: "Deals" },
  ];
