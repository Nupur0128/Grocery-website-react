...
export default function Vegetables() {
  ...
  const dealsImg = [
    { img: "/veg2.jpg", name: "Lancaster Farm Fresh Carrots - 1lb", price: "$ 5.99", category: "Deals" },
    { img: "/veg1.jpg", name: "Red Greenhouse Bell Pepper - 1lb", price: "$ 4.49", category: "Deals" },
    { img: "/veg3.jpg", name: "Beefsteak Tomatoes, Large -1lb", price: "$ 3.99", category: "Most Popular" },
    { img: "/veg5.jpg", name: "Greenhouse Cucumber - 1lb", price: "$ 0.99", category: "Fresh Finds" },
    { img: "/veg4.jpg", name: "Hass Avocados, Ready-to-Eat - 1lb", price: "$ 2.69", category: "Fresh Finds" },
  ];

  const filters = ["Deals", "Fresh Finds", "Most Popular"];
