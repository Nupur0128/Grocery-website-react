...
export default function CleaningSupplies() {
  ...
  const [counts, setCounts] = useState(Array(10).fill(1)); // initialized properly
  const [selectedFilters, setSelectedFilters] = useState([]);
  const [filterOpen, setFilterOpen] = useState(false); // mobile toggle

  const dealsImg = [
    { img: "/cleaningSup1.jpg", name: "Toilet Paper, 100 sheets", price: "$ 5.99", category: "Deals" },
    { img: "/cleaningSup2.jpg", name: "Cleaning Sponge", price: "$ 4.49", category: "Deals" },
    { img: "/cleaningSup3.jpg", name: "Floor Liquid Cleaner", price: "$ 3.99", category: "Most Popular" },
    { img: "/cleaningSup4.jpg", name: "Multi-Purpose Cleaner, Lemon", price: "$ 0.99", category: "Most Popular" },
    { img: "/cleaningSup5.jpg", name: "Powder Laundry Detergent", price: "$ 2.69", category: "Deals" },
    { img: "/cleaningSup6.jpg", name: "Glass Cleaner Spray", price: "$ 0.99", category: "Most Popular" },
    { img: "/cleaningSup7.jpg", name: "Dish Liquid 32.5 oz.", price: "$ 2.69", category: "Deals" },
    { img: "/cleaningSup8.jpg", name: "Frying Pan With Lid", price: "$ 0.99", category: "Deals" },
    { img: "/cleaningSup9.jpg", name: "Multi-Surface Spray Cleaner", price: "$ 2.69", category: "Most Popular" },
    { img: "/cleaningSup10.jpg", name: "Whitening Bleach", price: "$ 2.69", category: "Deals" },
  ];
