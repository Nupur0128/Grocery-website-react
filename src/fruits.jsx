...
export default function Fruits() {
  ...
  const dealsImg = [
    { img: "/fruit1.jpg", name: "Bartlett Pear - 1lb", price: "$ 1.29", category: "Deals" },
    { img: "/fruit2.jpg", name: "Ripe Apple - 1lb", price: "$ 1.20", category: "Fresh Finds" },
    { img: "/fruit3.jpg", name: "Navel Orange - 1lb", price: "$ 1.59", category: "Food" },
    { img: "/fruit4.jpg", name: "Strawberries - 1lb", price: "$ 4.49", category: "Most Popular" },
    { img: "/fruit5.jpg", name: "Banana Bunch - 1lb", price: "$ 1.89", category: "Start Your Cart" },
  ];

  const filters = ["Deals", "Food", "Fresh Finds", "Most Popular", "Start Your Cart"];
