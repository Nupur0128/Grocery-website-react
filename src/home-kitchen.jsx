...
export default function Kitchen() {
  ...
  const dealsImg = [
    { img: "/kitchen1.jpg", name: "Olive Oil", price: "$ 5.99", category: "Deals" },
    { img: "/kitchen2.jpg", name: "Wooden Cutting Board", price: "$ 4.49", category: "Most Popular" },
    { img: "/kitchen3.jpg", name: "Led Light Bulb 12W", price: "$ 3.99", category: "Deals" },
    { img: "/kitchen4.jpg", name: "Fluorescent Light Bulb 26W", price: "$ 0.99", category: "Most Popular" },
    { img: "/kitchen5.jpg", name: "Glass Bowl", price: "$ 2.69", category: "Deals" },
    { img: "/kitchen6.jpg", name: "Wooden Kitchen Utensils", price: "$ 0.99", category: "Deals" },
    { img: "/kitchen7.jpg", name: "Metal Grater", price: "$ 2.69", category: "Most Popular" },
    { img: "/kitchen8.jpg", name: "Frying Pan With Lid", price: "$ 0.99", category: "Deals" },
    { img: "/kitchen9.jpg", name: "Wooden Bowl Set 3 pc.", price: "$ 2.69", category: "Most Popular" },
    { img: "/kitchen10.jpg", name: "Cutting Knife Set 5 pc.", price: "$ 2.69", category: "Deals" },
  ];
